...
The emerging typology of knowledge types presented in this paper allows to study and characterize Q\&A knowledge dissemination within a community. In this study, we utilized the typology to discover that \SO and \RH support two distinct approaches for constructing knowledge, participatory knowledge construction and crowd-based knowledge construction, however each channel supports them differently. While participatory knowledge construction is more common on \RH, crowd knowledge construction is more prevalent on \SO.
