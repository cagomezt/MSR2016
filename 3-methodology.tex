...
we randomly sampled\footnote{Our sample data will be openly available online by camera ready} questions in both channels to characterize the types of discussions that occur. We iteratively sampled questions in each channel and coded
