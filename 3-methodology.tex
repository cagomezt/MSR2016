...
channels. We sampled 400 questions in each channel; this sample guaranteed both saturation and a reliability of 95\% $\pm$ 5\%. The second phase was a survey of members of the R-community to obtain further additional insights and to verify our findings. \alexey{the goal for the second phase is unclear. ``additional insights'' is not a good way to describe it.}
