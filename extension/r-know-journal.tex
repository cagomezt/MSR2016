...
all cases, they were found to be statistically different (with $\rho \ll 0.001$ in all cases).
    \begin{table*}[]
      ...
      \begin{small}
\begin{tabular}[h]{p{2.3cm}p{7.3cm}rrrrr}
...
\hline
  ...
  \emph{Clue/Suggestion/Hint}       & Provides a possible way to fix the issue without actually solving it.                                                                                                     & 43           & 105              & \textbf{5.33\% }        & \textbf{18.13\% }       \\
...
The number of common users we identified across both datasets is relatively small (around 2.5\% of all
...
Similarly, approximately two thirds of users in both channels only participate for a short period of one month and never actively participate again. 
...
\begin{description}[itemsep=2pt, topsep=0pt, leftmargin=1em, parsep=0pt]
  ...
  \item[I did it for you:] When answering, authors provide source code to help others: \textit{``I coded up the algorithm from the Cameron and Turner paper. Dunno if it gives exactly the same results as my (Splus?) code from lo these many years ago...''}
