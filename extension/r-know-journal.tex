...
\begin{abstract}
One of the many effects of social media on software development is the flourishing communities of practice where members share a common interest, such as programming languages, frameworks, and tools. These large communities use many different \channels but little is known about how they create, share, and curate knowledge using such channels.
