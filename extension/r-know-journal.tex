...
To determine which users were active in both channels, we compared the MD5 hashes of the email addresses extracted from the \RH mailing list and \SO. If there was a match, we associated the \SO user to the same person. Using this approach, we identified 1,449 persons who used both media channels.
