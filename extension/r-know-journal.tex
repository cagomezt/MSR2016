...
2013~\cite{Vasilescu2014c}. Figure~\ref{channelsActPerMonth} shows the activity of questions per month in both channels up to Sept 2016. We
...
have stabilized. Figure~\ref{channelsActPerMonthLatests} shows only the number of questions since Jan 2015. At it can be
...
\begin{figure*}[htbp]
  ...
  \caption{Detail of Figure~\ref{channelsActPerMonth} showing only activity after January 2015. As it can be seen, both
