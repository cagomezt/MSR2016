...
In \RH, all communication is done through emails, and authors do not explicitly tag them as updates. For this reason, we define an update on \RH as messages sent to a thread where the author has already participated once.
