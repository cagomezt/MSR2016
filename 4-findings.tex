...
description, and the frequency in the sample of 400 threads. Even though we did not aim for a statistically significant sample size, the size of this sample
