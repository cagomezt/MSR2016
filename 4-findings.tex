...
\textit{Crowd knowledge} construction is observable when:\cassie{does this apply to both RH and SO? we had a different "definition" for participatory knowledge for the two channels (above), but only one for crowd knowledge.}
  \begin{enumerate*}[label=(\arabic*)]
