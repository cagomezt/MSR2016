...
\toprule
    \multicolumn{2}{@{}l}{\textbf{Questions}} & \textbf{SO} & \textbf{RH} & \textbf{Prop SO} & \textbf{Prop RH} \\[0.2em]
...
\begin{comment}
    ...
    \multicolumn{2}{@{}l}{\textbf{Flags}} \\[0.2em]
    	\emph{Off-topic/opinion} & Identify questions that are unrelated to the list's interests or which answers are based on the opinion of channel
                                   participants (not actual facts). These flags can be assigned for different reasons or they can be used on different ways. & Off-topic/opinion & 22 & 19 & 27.16\% & 35.19\% \\
    ...
    %	\end{description}
    	\emph{Not an answer}     & Emphasize \textit{alternative answers} out of the scope of the question, or to identify that a solution does not answer the
                                   question. & Not an answer & 0 & 27 & 0.00\% & 50.00\% \\
    	\emph{Repeated question} & Acknowledge an user asking a repeated question. Either because the user could not find a proper answer that fits its needs or
                                   did not search the archives to see if the question was already asked. & Repeated question & 48 & 8 & 59.26\% & 14.81\% \\
    	\emph{Too localized}     & Questions that are too specific and might not help any future reader. & Too localized & 6 & 0 & 7.41\% & 0.00\% \\
    	\emph{Unclear} & Questions that are difficult to understand.\\[.4e & Unclear & 5 & 0 & 6.17\% & 0.00\% \\
    
    \multicolumn{2}{@{}l}{\textbf{Comments}} \\[0.2em]
    	\emph{Clarification} & Provides (or requests) additional information about a question or answer. & Clarification & 98 & 28 & 17.44\% & 10.49\% \\
    	\emph{Expansion} & Provides additional information. & Expansion & 127 & 65 & 22.60\% & 24.34\% \\
    	\emph{Correction/alternative} & Suggests a change to a question or answer, offers an alternative solution or a correction. & Correction/alternative & 102 & 89 & 18.15\% & 33.33\% \\
    	\emph{Compliment/criticism}   & Posts something good, offers thanks, provides an opinion or criticise someone. & Compliment/criticism & 157 & 52 & 27.94\% & 19.48\% \\
    	\emph{External reference}     & References an external resource. & External reference & 78 & 33 & 13.88\% & 12.36\% \\
            \bottomrule
\end{comment}
