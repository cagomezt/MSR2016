...
A short intro to background will be here... \alexey{I'll add that later}
...
\alexey{overall, this subsection is nice. Gives good overview of the R community. Some details perhaps could be shortened a bit. And we should selectively combine some stuff from ``that other section'' here.}
