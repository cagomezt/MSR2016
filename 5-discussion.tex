...
In contrast, \SO questions that trigger a discussion are flagged as opinion-based or off-topic and will likely be closed. 
...
One of the expected outcomes of this study is a set of recommendations for using multiple \channels.\cassie{are the recommendations for the people seeking answers and contributing answers, or are they more for the organizers? is this even an important distinction to make?}  Based on our results, we provide five
