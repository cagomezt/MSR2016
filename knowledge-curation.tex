\documentclass[oneside]{uvicthesis}
\include{macros}
...
%
\committee{% This list should NOT include the external examiner.
    \HRule\\\member{Dr. Margaret-Anne Storey}{Supervisor}{Department of Computer Science}
    \HRule\\\member{Dr. Daniel M. German}{Departmental Member}{Department of Computer Science}
}
...
\begin{acknowledgements}
	...
	\begin{itemize}
		\item Prof. Margaret-Anne Storey for her guidance, encouragement, and for giving me the opportunity to pursue something I never imagined I would be doing.

		\item Lorena Castañeda, my wife, without whom this effort would have been worth nothing. Your love, support and constant patience have taught me so much about sacrifice, discipline and compromise --- even if there were times when you said ``I told you so''.

		\item Jose Manuel, my son, for taking care of himself when I was trying to focus on this thesis, and helping to take care of his brother. 

		\item David Alejandro, my son, who was born before this thesis was completed and who spent many days with my wife to allow me to focus. I am deeply sorry for the time we spent apart.

		\item Cassandra Petrachenko, Germán Poo-Caamaño, Alexey Zagalsky, and Maryi Arciniegas  for the talks, the editing of the this thesis, and recommendations through these years.

		\item Chisel Lab and everybody in it during my time there, for being a great and supportive environment, making it easy to work and to laugh.
	\end{itemize}

\end{acknowledgements}

\begin{dedication}
	\noindent This thesis is dedicated to Jose Manuel and David Alejandro.
\end{dedication}
...
\label{cha:introduction}
	...
	Programmers can consult a variety of online resources (e.g., Stack Overflow\footnote{\url{http://stackoverflow.com/}}, and Nabble\footnote{\url{http://www.nabble.com/}}) by entering combinations of keywords in a search engine (e.g., Google\footnote{\url{http://www.google.com/}}).
	...
	% MOTIVATION: Developers use multiple media channels, some of those media channels serve to the same purpose, so why do developers use both?
...
\section{Contributions}
	...
	\begin{figure}[!htb]
		\centering
		\includegraphics[width=1\textwidth]{Figures/RQ-contributions}
...
\section{Thesis Outline}
	...
	\begin{itemize}
		\item Chapter \ref{cha:background} presents the context and background of this work, including media channels and communities of practice. It also introduces the R community along with the two media channels investigated as part of this thesis: the R-Help mailing list and the Stack Overflow R Tag. 

		\item Chapter \ref{cha:methodology} describes the elements of my methodology (i.e., research questions, case study method, study design, and content analysis definition), as well as the constructivist position taken in this work, and the study design (i.e., case study and survey).

		\item Chapter \ref{cha:findings} presents the results of data analysis aligned to the research questions. 
		It  contains a classification of knowledge type, an explanation of how the knowledge is constructed, a description of the roles of links on the construction of knowledge, and an analysis of why users post in both media channels.
		Further, this chapter presents the survey results with pros and cons of both media channels.

		\item Chapter \ref{cha:theory} presents a theory that integrates the findings with the survey results to better understand the interplay of media channels.

		%\item Chapter \ref{cha:survey} presents the design, deployment and results of our survey, which includes closed questions aimed to profile the responders as well as their type of participation; the survey also contains open ended questions to elicit the pros and cons of using both channels.

		\item Chapter \ref{cha:discussion} presents a discussion of my contributory results, consisting of a comparison between Stack Overflow and the R-help mailing list, a Q\&A knowledge categorization, a set of recommendations when using multiple channels, and a description GTMail tool that makes it different to other approaches.

		\item Chapter \ref{cha:threats} describes the threats to validity found in this work, including internal and external validities, and standards of rigour.

		\item Chapter \ref{cha:future-work} proposes future work based on my findings.

		\item Chapter \ref{cha:conclusion} presents the conclusions of this thesis.
	\end{itemize}

%%% Local Variables:
%%% mode: latex
%%% TeX-master: "../mainthesisUVIC"
% mainfile: "../mainthesisUVIC"
%%% End:
...
\subsection* {R-help Mailing List}
...
\label{subsec:Rtag}
	...
	\begin{figure}[!htb]
	\centering
	\includegraphics[width=0.8\linewidth]{Figures/SOInterface_A}
	...
	\begin{figure}[!htb]
	\centering
	\includegraphics[width=0.8\linewidth]{Figures/SOInterface_B}
	...
	\begin{figure}
		\centering
		\includegraphics[width=1\linewidth]{Figures/VasilescuFA1}
		\includegraphics[width=1\linewidth]{Figures/VasilescuFA2}
...
\section{Case Study Methodology}
	...
	\begin{figure} [!ht]
		\centering
		\includegraphics[width=0.9\linewidth]{Figures/StudyPhases}
		\caption{General overview of the study design}
		\label{fig:StudyPhases}
	\end{figure}

\section{Phase 1: Mining Data Archives} 
...
\label{subsec:preparation}
	...
	\begin{figure*}[!htb]
		\centering
		\includegraphics[width=\linewidth]{Figures/data_extraction}
...
\label{subsec:r-help}
	...
	\begin{figure}[!htb]
		\centering
		\includegraphics[width=0.8\linewidth]{Figures/WellFormedEmail}
	...
	%Examples of how the tool stores data, as well as the implementation of the Zawinski's threading algorithm are presented in Appendix~\ref{cha:appendicesD}.
	%>>

	\begin{figure} [!ht]
		\centering
		\includegraphics[width=\linewidth]{Figures/ML-ERD}
...
\subsubsection*{Stack Overflow}
	...
	\begin{figure} [!ht]
		\centering
		\includegraphics[width=0.8\linewidth]{Figures/SO-ERD}
...
\label{sec:dap}
	...
	\begin{figure} [!htb]
		\centering
		\includegraphics[width=1\linewidth]{Figures/ContentAnalysisFlow_3}
...
\subsubsection*{Techniques Used to Support the Analysis}
...
\subsubsection*{The Analysis Process}
	...
	\begin{landscape}
	 	\begin{figure}[!ht]
			\centering
			\includegraphics[width=1\linewidth]{Figures/CodingExample}
...
\section{Phase 2: The Survey} 
	...
	The questions posed in this survey are listed in Appendix \ref{cha:appendicesC}.
...
\section{RQ-1. What types of knowledge are shared on Stack Overflow and the R-help mailing list within the R community?}
...
\subsection*{Flags}
	...
	\begin{figure} [!htb]
		\centering
		\includegraphics[width=0.9\linewidth]{Figures/SOFlagsExample}
...
\subsection*{Comments}
	...
	\begin{figure}
		\centering
		\includegraphics[width=0.7\linewidth]{Figures/ExCommentUpdate1}
		\includegraphics[width=0.7\linewidth]{Figures/ExCommentUpdate2}
...
\section{RQ-2. How is knowledge constructed on Stack Overflow and the R-help mailing list?}
\label{sec:rq2}
%\section{Construction of Knowledge}
	...
	\begin{figure}[!htb]
		\centering
		\includegraphics[width=0.8\linewidth]{Figures/ML-PKimg2}
		\includegraphics[width=0.8\linewidth]{Figures/ML-PKimg11}
	...
	\begin{figure}[!htb]
		\centering
		\includegraphics[width=.8\linewidth]{Figures/SO-PKimg5}
		\includegraphics[width=.8\linewidth]{Figures/ML-PKimg1}
...
%	\remarks{FIX THE FIGURE}
	...
	\begin{figure} [!htb]
		\centering
		\includegraphics[width=0.8\linewidth]{Figures/SO-CSimg2}
		\caption{Examples of how crowd knowledge construction occurs.}
		\label{fig:CKC_MLSO}
	\end{figure}

\section{RQ-3. How does the sharing of links on Stack Overflow and the R-help mailing list support knowledge construction? }
...
\section{RQ-4. Why do Certain Users Post to Both Stack Overflow and the R-help Mailing List}
...
\label{sec:survey}
	...
	In the survey, the main findings aligned with the thesis results come from the open questions that gather information about the experiences of the participants on Stack Overflow and the R-help mailing list---the complete version of the results is in Appendix \ref{cha:appendicesA}.
...
\section{Comparison of How Knowledge is Shared on Both Channels}
	...
	\subsection{Curated knowledge and knowledge development}
...
\section{Recommendations For Using Multiple Q\&A Media Channels}
	...
	\subsection{Choose the correct channel}
		...
		\begin{figure} [!htb]
			\centering
			\includegraphics[width=0.7\linewidth]{Figures/CCchannel}
	...
	\subsection{Read the user manuals, channel rules and learn the basic concept of the technology used}
	...
	\subsection{Provide a Background to the Question}
...
\section{Recommendations For Using External Resources}
...
\section{Comparison of the Way Knowledge is Shared on Both Channel}
...
\section{Message Categorization}
...
\label{cha:future-work}
	...
	\section*{Is the categorization of knowledge different in other software development communities?}
	...
	\section*{Are the topics of discussion the same for the R-help mailing list and Stack Overflow?}
	...
	\section*{What should be the next evolutionary step for the R-help mailing list?}
...
\label{cha:conclusion}
	...
	\appendix
	\chapter{}
\label{cha:appendicesA}

	This chapter present the results of the close question asked on the survey. 
	Most of the closed questions were of multiple selection, which are presented on bar graphs, given that the total of the answers do not represent the number of participants who answered. 
	The rest of answers are presented on pie charts as the number of the answers represent the 100\% of the population.
...
\subsection{The Participants}
	...
	As mentioned before, we distributed our survey through different media channels.
	We targeted users of R language regardless of their occupation and area of expertise.
	We used multiple-choice questions to get information that could help us profile the participants of our survey:

	{\itshape
	\begin{itemize}
		\item What is your area of expertise?
		\item What is your occupation?
		\item How would you describe your participation in the R community?
	\end{itemize}
	}

	Figure \ref{fig:SV1} summarizes their responses.
	The majority of the participants selected areas of expertise different to computer science. 
	It is worth mentioning, that Stack Overflow is a channel dedicated to software development topics. 
	Therefore, it is possible that Stack Overflow does not fully support the communication needs of the R community.
	Among the occupations reported included consultants, retailers, and government researchers. 
	Surprisingly,many participants were package maintainers. 
	We expected that this type of users would be more active in the channels of their corresponding packages rather than the ones we were studying.

	\begin{figure} [ht!]
		\centering
		\includegraphics[width=1\linewidth]{Figures/SV1}
		\caption{Demographic profile of the participants.}
		\label{fig:SV1}
	\end{figure}
	...
	{\itshape
		\begin{itemize}
			\item How would you rank yourself as a software developer?
			\item How would you rank yourself as an R user?
		\end{itemize}
	}

	Figure \ref{fig:SV2} depicts the answers to these questions. 
	Although, most users were non-computer-scientists, we were surprised to find that the majority have experience with programming.

	\begin{figure} [ht!]
	\centering
	\includegraphics[width=1\linewidth]{Figures/SV2}
	\caption{(on the left) Programming experience as programmers; (on the right) Programming experience as R programmers}
	\label{fig:SV2}
	\end{figure}


\subsection{The Usage of the Media Channels}

	All of the 26 participants reported using of Stack Overflow.
	Given that most participants were experienced with programming, we could infer that would employ Stack Overflow.
	In contrast, only 20 participants used the R-help mailing list.
	%Regardless of the channel questions asked expressed pros and cons of each channel.

	We were interested in the form of participation on each media channel. 
	For this purpose we formulated closed questions in which users were presented multiple forms of participation (e.g., ask questions, write answers, edit answers or questions, add comments, and browse for information) and they had to provide a ranking value according a scale (never, rarely, sometimes, often, always, and no answer):
	{\itshape
		\begin{itemize}
			\item How do you participate on Stack Overflow/the R-help mailing list? 
			\item When looking for an answer, what do you read? 
			\item Before posting/writing your answer, what do you read? 
		\end{itemize}
	}

	Figure \ref{fig:participation} depicts the participation on the channels. 
	It was very interesting to see that the participants often consult the channels to browse for information and rarely to ask questions. 
	By this, we can infer that most of the survey participant just consume channel knowledge.

	\begin{figure} [ht!]
	\centering
	\includegraphics[width=1\linewidth]{Figures/SO-participation}
	\includegraphics[width=1\linewidth]{Figures/ML-participation}
	\caption{Participation on Stack Overflow and R-help mailing list.}
	\label{fig:participation}
	\end{figure}

	
	Figure \ref{fig:lookingAns} depicts what users read from the thread before posting an answer.
	As expected, most users of Stack Overflow look for the accepted answer, but still there is a very active participation on reading all answers and comments.
	In the case of the R-help mailing list, there is more variation in the responses. 
	We think this is because of the email format requires a better examination of the thread before finding an answer or solution to a problem.  
	\begin{figure}[ht!]
		\centering
		\includegraphics[width=1\linewidth]{Figures/SO-lookingAns}
		\includegraphics[width=1\linewidth]{Figures/ML-lookingAns}
		\caption{Behaviour of the participants during enquiry process. Stack Overflow on top, R-help mailing list on the bottom.}
		\label{fig:lookingAns}
	\end{figure}

	Figure \ref{fig:readBefPost} depicts the behaviour of the participants before posting/writing an answer.
	As noted, many participants did not provide an answer to the question. 
	This is not a surprise, since participants tend to look for answers rather than provide them.
	However, for those who did answers it is interesting that they try to avoid repeating answers by examining previous answers before posting.
	This means that the participants are interested to preserve the quality of the channel by not posting redundant information.
	\begin{figure}[ht!]
		\centering
		\includegraphics[width=1\linewidth]{Figures/SO-readBefPost}
		\includegraphics[width=1\linewidth]{Figures/ML-readBefPost}
		\caption{Behaviour of the participants prior to a response.}
		\label{fig:readBefPost}
	\end{figure}

	Finally, we asked about the usage of links on these channels.
	In this question, we provided multiple types of usage (i.e., input data, source code, documentation, external libraries, authors/users, publicity, and apps) and the participants were asked to provide a rank according to scale: Not important at all, Somewhat important, Important, Very Important, Not sure/Not Applicable, and No answer.
	{\itshape
	\begin{itemize}
		\item In your opinion, links are mechanisms to share.
	\end{itemize}
	}

	Figure \ref{fig:ResourcesUsage} depicts the opinions of the participants about resources usage. 
	It is worth mentioning that despite the variety of answers, we can highlight that documentation and source code are the most common reasons for providing links. 

	\begin{figure}[ht!]
		\centering
		\includegraphics[width=1\linewidth]{Figures/ResourcesUsage}
		\caption{How resources are used according to participants of the survey}
		\label{fig:ResourcesUsage}
	\end{figure}



	\chapter{}
\label{cha:appendicesB}
	This chapter presents the queries templates that I used to select the information for this study. 
	Additionally, this chapter presents the queries used to create the table from which I extracted the information to code.

\section{Database Queries}

	\paragraph{Random rows:} The instruction to force PostgreSQL to return random results \texttt{ORDER~BY~RANDOM()}.
	Additionally, The instruction to force PostgreSQL to return a limited number of rows is \texttt{LIMIT~\textless NUMBER\textgreater}.
	Code \ref{query1} depicts the query template used to returns random.

	\lstinputlisting[language=SQL, label=query1, caption={Query that returns a limited number of rows ordered randomly between two years.}]{SourceCode/PSRandom.sql}

	\paragraph{Threads with the same title and authors:} Using the MD5 hash I matched threads with the same author and the same title across the R-help mailing list and Stack Overflow.
	Code \ref{query2} presents the query template used to match authors and titles on both channels.

	\lstinputlisting[language=SQL, label=query2, caption={Query that returns all the threads that share the same title and author.}]{SourceCode/MatchUsers.sql}

	\paragraph{Table creation:} I created tables that contain all the possible information of Stack Overflow and the R-help mailing list on the spreadsheet format. 
	Code \ref{query2} shows the query used to create the tables for the threads

	\lstinputlisting[language=SQL, label=query3, caption={Table template based on a query that returns all the possible threads that can be coded for this thesis.}]{SourceCode/ThreadsToCode.sql}

\section{Data}

	All the messages that I used for this study are available in PostgreSQL dump format at \url{https://github.com/cagomezt/RResearch}. 
	The email address and the MD5 hash have been deleted from the data for privacy reasons.
	\chapter{}
\label{cha:appendicesC}

	This appendix lists the questions used in the survey highlighted in Chapter \ref{cha:methodology}. The questions were open ended and close questions (i.e., multiple selection and unique selection). A copy of the survey is published in \url{http://goo.gl/mxmH5J}
...
\subsection{The User}
	...
	\begin{itemize}
		\item What is your area of expertise? (Computer Science, Mathematics, Life Science, Healthcare, and others).

		\item What is your occupation? (Academia, Student, Industry, and Other).

		\item Do or did you have experience as a software developer/programmer prior to learning or using R? (yes or not).

		\item How would you rank yourself as a software developer? (Beginner, Advance beginner, Competent, Proficient, and Expert).

		\item How would you rank yourself as an R user? (Beginner, Advance beginner, Competent, Proficient, and Expert).

		\item How would you describe your participation in the R community? (I'm just an R user, I contribute to the R documentation, I'm one of the R core developers, I write or maintain R packages, I submit R bugs, I am not Involved at all, and Other).

		\item Have you used Stack Overflow? (yes or no).

		\item How do you participate on Stack Overflow? (Never, Rarely, Sometimes, Often, Always).
		\begin{itemize}
			\item Ask questions?
			\item Write answers?
			\item Edit answers or questions?
			\item Add comment?
			\item Browse for information?
		\end{itemize}

		\item When looking for an answer, what do you read? (Never, Rarely, Sometimes, Often, Always).
		\begin{itemize}
			\item The accepted answer (if any)?
			\item All answers?
			\item Comments?
			\item Read the answers until find something that works for you?
		\end{itemize}

		\item Before posting your answer, what do you read? (Never, Rarely, Sometimes, Often, Always).
		\begin{itemize}
			\item Read all answers?
			\item Read all comments?
		\end{itemize}
		...
		\item Have you used the R-Help Mailing List? (yes or no)

		\item How do you participate in the R-Help Mailing List? (Never, Rarely, Sometimes, Often, Always).
		\begin{itemize}
			\item Ask questions?
			\item Write answers?
			\item Browse for information?
		...
		\item When looking for an answer, what do you read?  (Never, Rarely, Sometimes, Often, Always).
		\begin{itemize}
			\item The entire thread?
			\item Answers that were validated by the author of the question (if any)?
			\item The answers of recognized users?
			\item Read the answers until find something that works for you?
		\end{itemize}

		\item Before writing your answer, what do you read? (Never, Rarely, Sometimes, Often, Always).
		\begin{itemize}
			\item The entire thread?
			\item The answers of recognized users?
		\end{itemize}
		...
		\item Why do you think the R-Help Mailing List has not been replaced by Stack Overflow? Please elaborate.

		\item In what situations would you choose Stack Overflow over the R-Help Mailing List? Please elaborate.

		\item In what situations would you choose R-Help Mailing List over Stack Overflow ? Please elaborate.

		\item When you see a link on a question, answer or comment. Do you click on it? Why? Please elaborate.

		\item In your opinion, links are mechanisms to share... (Not important at all, Somewhat important, Important, Very Important, Not sure/Not Applicable)
		\begin{itemize}
			\item Input data?
			\item Source code?
			\item Documentation?
		...
		\item Within the context of Stack Overflow and the R-Help Mailing List, can you think of any other benefits of using links? Please elaborate.
	\end{itemize}
	%<<
\chapter{}
\label{cha:appendicesD}
...
\subsection{Threading}
	...
	GTMail tool implements the Jamie Zawinski's algorithm\footnote{\url{https://www.jwz.org/doc/threading.html}} to do the threading of emails. 
	Zawinski's algorithm is capable of dealing with threading and sub-threading.
	Figure \ref{fig:NabbleThread} shows an example of the thread \textit{``Median of streaming data''} visualized on the Nabble website (an online R-help archive), and how the same data is stored in the database.

	\begin{figure} [ht!]
		\centering
		\includegraphics[width=1\linewidth]{Figures/NabbleThread}
		\caption{Example of how we stored threads on the database after GTMail processed the data. (LEFT) An example of how the messages on a thread are visualized on Nabble. (RIGHT) How the information of threads is stored in the database}
		\label{fig:NabbleThread}
	\end{figure}


\subsection{Messages}

	Figure \ref{fig:Message} depicts an example of how the messages are store in the database, as well as its visualization on the Nabble website.

	\begin{figure} [ht!]
		\centering
		\includegraphics[width=1\linewidth]{Figures/Message}
		\caption{Example of how messages are stored in the database, and how are they visualized in the Nabble website. (LEFT) The message visualized on Nabble. (RIGHT) The message as stored in the database}
		\label{fig:Message}
	\end{figure}
%>>
