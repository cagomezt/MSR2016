...
% Adjust settings from the class to make them fit with UVic LaTeX template
\renewcommand{\defaultspacing}{\onehalfspacing}
\renewcommand{\floatpagefraction}{0.01} % Float Customization
\renewcommand{\cftfignumwidth}{0.80in}  % Figure's separation space in the ToC

\newcommand{\HRule}{\rule{\linewidth}{0.5mm}}

% ----PACKAGE listings 
% Source code formating
%\captionsetup[lstlisting]{margin=5pt}
\lstset{
    frame=single,
    frameround=tttt,
    framesep=6pt,
