...
\usepackage[hidelinks,draft]{hyperref} % back-referencing + hyperlinks
...
\newcommand{\myauthor}{Alexey Zagalsky et al.}
\newcommand{\mysubject}{Q&A Knowledge curation typology}
